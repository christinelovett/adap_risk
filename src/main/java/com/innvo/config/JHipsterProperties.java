...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "adap_risk@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "adap_risk API";

        private String description = "adap_risk API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "adap_risk";

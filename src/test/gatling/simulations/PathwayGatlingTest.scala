...
class PathwayGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Pathway entity")
        ...
        .repeat(2) {
            ...
            .post("/api/pathways")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "nameshort":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "isabstract":null, "condition":"SAMPLE_TEXT", "status":"SAMPLE_TEXT", "lastmodifiedby":"SAMPLE_TEXT", "lastmodifieddatetime":"2020-01-01T00:00:00.000Z", "domain":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
